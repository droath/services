...
class VocabularyTreeGet extends ServiceDefinitionBase implements ContainerFactoryPluginInterface {
     ...
     * {@inheritdoc}
     */
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition, $serializer) {
        return new static($configuration, $plugin_id, $plugin_definition, $serializer);
    }
